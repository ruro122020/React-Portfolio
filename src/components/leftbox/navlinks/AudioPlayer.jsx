...
import soundbay from '../../../assets/soundbay.mp4'
...
const AudioPlayer = () => {
  ...
  const [timerMax, setTimerMax] = useState(null)
  ...
  return (
    <div className='border-2 border-white md:flex'>
      ...
      {/* Audio Visuals */}
      {/* <div>
        <video ref={video} width='200' height='50'>
          <source src={soundbay} type="video/mp4" />
        </video>
      </div> */}
    </div>
  )
